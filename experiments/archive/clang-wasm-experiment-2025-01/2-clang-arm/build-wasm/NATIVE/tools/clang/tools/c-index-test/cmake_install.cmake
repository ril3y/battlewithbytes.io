# Install script for directory: /build/llvm-project/clang/tools/c-index-test
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xc-index-testx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/build/build-wasm/NATIVE/bin/c-index-test")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/c-index-test" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/c-index-test")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/c-index-test"
         OLD_RPATH "\$ORIGIN/../lib:/build/build-wasm/NATIVE/lib:"
