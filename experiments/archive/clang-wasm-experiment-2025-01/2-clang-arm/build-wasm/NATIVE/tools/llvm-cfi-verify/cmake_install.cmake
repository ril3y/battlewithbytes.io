# Install script for directory: /build/llvm-project/llvm/tools/llvm-cfi-verify
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xllvm-cfi-verifyx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/build/build-wasm/NATIVE/bin/llvm-cfi-verify")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-cfi-verify" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-cfi-verify")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-cfi-verify"
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("/build/build-wasm/NATIVE/tools/llvm-cfi-verify/lib/cmake_install.cmake")
endif()
