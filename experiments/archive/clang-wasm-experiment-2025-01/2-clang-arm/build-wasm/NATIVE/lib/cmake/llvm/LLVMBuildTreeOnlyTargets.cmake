...
foreach(_expectedTarget LLVMHello FileCheck llvm-PerfectShuffle count not UnicodeNameMappingGenerator yaml-bench split-file SampleAnalyzerPlugin CheckerDependencyHandlingAnalyzerPlugin CheckerOptionHandlingAnalyzerPlugin BugpointPasses lli-child-target llvm-jitlink-executor obj2yaml yaml2obj ExampleIRTransforms Bye)
...
set_target_properties(LLVMHello PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/lib/LLVMHello.so"
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/bin/FileCheck"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/bin/llvm-PerfectShuffle"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/bin/count"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/bin/not"
  )
...
set_target_properties(UnicodeNameMappingGenerator PROPERTIES
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/bin/UnicodeNameMappingGenerator"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/bin/yaml-bench"
  )
...
set_target_properties(split-file PROPERTIES
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/bin/split-file"
  )
...
set_target_properties(SampleAnalyzerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/lib/SampleAnalyzerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(CheckerDependencyHandlingAnalyzerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/lib/CheckerDependencyHandlingAnalyzerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(CheckerOptionHandlingAnalyzerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/lib/CheckerOptionHandlingAnalyzerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(BugpointPasses PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/lib/BugpointPasses.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/bin/lli-child-target"
  )
...
set_target_properties(llvm-jitlink-executor PROPERTIES
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/bin/llvm-jitlink-executor"
  )
...
set_target_properties(obj2yaml PROPERTIES
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/bin/obj2yaml"
  )
...
set_target_properties(yaml2obj PROPERTIES
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/bin/yaml2obj"
  )
...
set_target_properties(ExampleIRTransforms PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/lib/ExampleIRTransforms.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(Bye PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/build/build-wasm/NATIVE/lib/Bye.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
