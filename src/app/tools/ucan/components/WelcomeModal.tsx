    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-8">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {/* What is uCAN */}
          <div>
            <h3 className="text-xl font-semibold text-white mb-3">What is uCAN?</h3>
            <p className="text-gray-300 leading-relaxed">
              uCAN is a browser-based CAN bus packet analyzer that works with USB-to-CAN hardware adapters.
              It provides a Wireshark-like interface for monitoring, analyzing, and transmitting CAN messages
          ...
          <div className="bg-blue-600/10 border border-blue-500/30 rounded-lg p-4">
            <h4 className="text-lg font-semibold text-blue-400 mb-2">Demo Mode Active</h4>
            <p className="text-gray-300 text-sm">
              You&apos;re currently viewing demo data. To use uCAN with real hardware:
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start gap-2">
                ...
                <span><strong>Real-time Monitoring:</strong> Capture and display CAN packets as they arrive</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-1">✓</span>
                <span><strong>Filtering & Search:</strong> Filter by CAN ID, direction, and more</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-1">✓</span>
                <span><strong>Packet Transmission:</strong> Send CAN messages to the bus</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-1">✓</span>
                <span><strong>Multiple Views:</strong> List, hex dump, and statistics views</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-1">✓</span>
                <span><strong>Export Data:</strong> Export captures as CSV or JSON</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-1">✓</span>
                <span><strong>No Installation:</strong> Runs entirely in your browser</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-yellow-600/10 border border-yellow-500/30 rounded-lg p-4">
            <h4 className="text-lg font-semibold text-yellow-400 mb-2">Browser Compatibility</h4>
            <p className="text-gray-300 text-sm">
