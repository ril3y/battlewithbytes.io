...
interface DefinitionManagerModalProps {
  ...
  onUploadDefinition: (file: File) => Promise<{ success: boolean; error?: string }>;
}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-3xl max-h-[80vh] bg-gray-900 border border-gray-700 rounded-lg shadow-2xl flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <div>
            <h2 className="text-xl font-bold text-white">CAN Overlay Definitions</h2>
            <p className="text-sm text-gray-400">Select or upload a definition to decode messages</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="bg-gray-800 border border-gray-700 rounded p-4">
            <h3 className="text-sm font-semibold text-white mb-2">Upload Custom Definition</h3>
            <div className="flex items-center gap-2">
              <label className="flex-1">
                <input
                  ...
                  className="hidden"
                />
                <div className={`px-4 py-2 text-sm border border-gray-600 rounded cursor-pointer text-center transition-colors ${
                  uploading
          ...
          {/* Definitions List */}
          <div>
            <h3 className="text-sm font-semibold text-white mb-2">Available Definitions</h3>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          {def.author && (
                            <p className="text-xs text-gray-500">Author: {def.author}</p>
                          )}
