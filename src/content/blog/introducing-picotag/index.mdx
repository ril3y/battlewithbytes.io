...
author: "Riley Porter" # Assuming Riley Porter based on the prompt, adjust if needed
coverImage: "./images/cover.png" # Placeholder - ensure this image exists or update path
---
