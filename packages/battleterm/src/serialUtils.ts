...
import type { SerialConfig, LineEnding, ParsedSerialData } from './serialTerminal.types';
 ...
 */
export function parseSerialData(data: Uint8Array, timestamp?: Date): ParsedSerialData {
