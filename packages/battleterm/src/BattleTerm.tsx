...
export default function SerialTerminal({
  ...
  return (
    <div
      className={`bg-gray-900/50 border-2 border-green-500/30 rounded-lg shadow-[0_0_20px_rgba(34,197,94,0.15)] overflow-hidden flex flex-col ${isStandalone ? "h-full" : ""}`}
    >
