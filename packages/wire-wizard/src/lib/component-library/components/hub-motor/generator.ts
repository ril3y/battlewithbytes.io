...
export function generate(config: HubMotorConfig = {}): GeneratorResult {
  ...
  const connectionPoints: ConnectionPointDefinition[] = [
    ...
    // Hall-sensor harness — internal pins are hidden on the canvas and live in
    // the pinout drill-in view. Wires terminate at the harness bus port below.
    {
      id: 'hall-a',
      label: 'Hall A',
      x: connectorStartX + 2,
      ...
      pinNumber: 1,
      signalType: 'signal',
      description: 'Hall sensor phase A',
    },
    {
      id: 'hall-b',
      label: 'Hall B',
      ...
      pinNumber: 2,
      signalType: 'signal',
      description: 'Hall sensor phase B',
    },
    {
      id: 'hall-c',
      label: 'Hall C',
      ...
      pinNumber: 3,
      signalType: 'signal',
      description: 'Hall sensor phase C',
    },
    {
      id: 'hall-vcc',
      label: '+5V',
      ...
      signalType: 'power',
      voltage: 5,
      description: 'Hall sensor +5V supply',
    },
    {
      id: 'hall-gnd',
      label: 'GND',
      ...
      pinNumber: 5,
      signalType: 'ground',
      description: 'Hall sensor ground',
    },
    {
      id: 'harness-bus',
      label: 'Harness',
      ...
      radius: 7,
      isBusPort: true,
      internalPinIds: ['hall-a', 'hall-b', 'hall-c', 'hall-vcc', 'hall-gnd'],
      description: 'Hall-sensor harness — drill in to assign per-pin wires',
    },
  ];
