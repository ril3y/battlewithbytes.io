...
const formatDisplayValue = (
  value: string,
  fieldType: "voltage" | "current" | "resistance" | "power",
): string => {
...
const OhmsLawDiagram: React.FC<OhmsLawDiagramProps> = ({
  values,
  calculatedProperty,
}) => {
  // Determine which values to highlight based on what was calculated
  const getHighlightColor = (
    property: "voltage" | "current" | "resistance" | "power",
  ) => {
  ...
  return (
    <div className="ohms-law-diagram">
      <div className="bg-black/30 border border-gray-800 rounded-lg p-6 mb-6">
        <div className="text-sm text-[#00ff9d] font-mono mb-4">
          OHM&apos;S LAW DIAGRAM
        </div>
