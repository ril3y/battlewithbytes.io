...
export default function MosfetDiagram({
  mosfetType,
  inputValues,
}: MosfetDiagramProps) {
  return (
        ...
        {mosfetType === "n-channel" ? (
          <div className="relative w-full h-64 bg-black/30 rounded-lg p-4">
            <svg viewBox="0 0 300 200" className="w-full h-full">
              ...
              {/* Load Resistor */}
              <path
                d="M150,50 L140,55 L160,65 L140,75 L160,85 L140,95 L160,105 L150,110"
                fill="none"
                stroke="#00ff9d"
                strokeWidth="2"
              />
              ...
              <polygon
                points="145,155 150,150 145,145"
                fill="#00ff9d"
                stroke="#00ff9d"
                strokeWidth="1"
              />
          ...
          <div className="relative w-full h-64 bg-black/30 rounded-lg p-4">
            <svg viewBox="0 0 300 200" className="w-full h-full">
              ...
              {/* Load Resistor */}
              <path
                d="M150,110 L140,115 L160,125 L140,135 L160,145 L140,155 L160,165 L150,170"
                fill="none"
                stroke="#00ff9d"
                strokeWidth="2"
              />
