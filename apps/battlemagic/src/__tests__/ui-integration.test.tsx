...
describe('Argument Annotation UI', () => {
  it('should render argument annotation in compact mode', () => {
    ...
    // Compact mode shows only args text (no function name)
  ...
  it('should display function name when provided', () => {
    ...
    // Non-compact mode shows function name
    render(
      <ArgumentAnnotation
  ...
  it('should show default func name when none provided in non-compact mode', () => {
    const annotation = {
      call_address: 0x08000104,
      function_target: 0x08000200,
...
describe('Vector Table Panel UI', () => {
  ...
  it('should show validity status for each entry', async () => {
    ...
    await waitFor(() => {
      ...
      // Invalid/NULL entries (may appear in both stats and table)
