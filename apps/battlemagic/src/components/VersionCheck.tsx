...
import {
  ...
  FeatureStatus,
  BmpFeature,
} from "../lib/version/VersionManager";
import {
  ChevronDownIcon,
  ChevronRightIcon,
  CheckCircleIcon,
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span
                className={`px-2 py-1 text-xs rounded-full font-medium ${getBadgeClasses()}`}
              >
                {displayVersion}
              </span>
                  ...
                  return (
                    <div key={category} className="space-y-2">
                      <div className="flex items-center space-x-2 text-sm font-medium text-gray-300">
                        <span>
                          {getCategoryIcon(category as BmpFeature["category"])}
                        </span>
                      ...
                      <div className="ml-6 grid grid-cols-2 gap-2">
                        {features.map((feature) => {
                          const status = versionManager.isFeatureAvailable(
                            feature.id,
                          );
                          return (
                            <div
