 ...
 *
 * Source: src/app/tools/battleforge/data/boards/ (git submodule - battleforge_boards repo)
 * Dest:   public/tools/battleforge/
 *
...
const SUBMODULE_DIR = path.join(__dirname, '../src/app/tools/battleforge/data/boards');
const PUBLIC_DIR = path.join(__dirname, '../public/tools/battleforge');
