        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-black/50 border border-gray-800 rounded-lg overflow-hidden hover:border-green-400/50 transition-all duration-300 transform hover:-translate-y-1">
            <div className="p-6">
              ...
              <p className="text-gray-400 mb-4">
                Interactive tool for calculating MOSFET parameters, visualizing
                configurations, and determining conduction states.
              </p>
              <Link
                href="/tools/mosfet-calculator"
          ...
          <div className="bg-black/50 border border-gray-800 rounded-lg overflow-hidden hover:border-green-400/50 transition-all duration-300 transform hover:-translate-y-1">
            <div className="p-6">
              ...
              <p className="text-gray-400 mb-4">
                ...
                Ohm&apos;s Law with an interactive visualization and detailed
                explanations.
              </p>
              <Link
          ...
          <div className="bg-black/50 border border-gray-800 rounded-lg overflow-hidden hover:border-green-400/50 transition-all duration-300 transform hover:-translate-y-1">
            <div className="p-6">
              ...
              <p className="text-gray-400 mb-4">
                Create visual pinout & wiring harness maps for electrical
                connectors. Define, preview, and map electrical components.
              </p>
              <Link
                href="/tools/wiremapper"
                className="text-green-400 font-mono text-sm hover:underline"
              >
                Open tool →
              </Link>
          ...
          <div className="bg-black/50 border border-gray-800 rounded-lg overflow-hidden hover:border-green-400/50 transition-all duration-300 transform hover:-translate-y-1">
            <div className="p-6">
              ...
              <p className="text-gray-400 mb-4">
                Modern web-based serial port terminal with ANSI color support,
                hex view, macros, and full Unicode support for device
                communication.
              </p>
              <Link
                href="/tools/serial-terminal"
                className="text-green-400 font-mono text-sm hover:underline"
              >
                Open tool →
              </Link>
          ...
          <div className="bg-black/50 border border-gray-800 rounded-lg overflow-hidden hover:border-green-400/50 transition-all duration-300 transform hover:-translate-y-1">
            <div className="p-6">
              ...
              <p className="text-gray-400 mb-4">
                Browser-based CAN bus packet analyzer with real-time monitoring,
                filtering, and action automation for USB-to-CAN hardware.
              </p>
              <Link
                href="/tools/ucan"
                className="text-green-400 font-mono text-sm hover:underline"
