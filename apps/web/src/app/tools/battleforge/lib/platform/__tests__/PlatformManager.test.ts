  ...
  describe('generateBuildConfig', () => {
    describe('Native Framework', () => {
      ...
      it('should include platform header paths', async () => {
        ...
        expect(config.includePaths).toContain('/platform/stm32/f1/headers/cmsis');
        expect(config.includePaths).toContain('/platform/stm32/f1/headers/device');

        // Should NOT include Arduino paths
        expect(config.includePaths).not.toContain('/framework/arduino/cores/arduino');
      });
    ...
    describe('Arduino Framework', () => {
      ...
      it('should include Arduino framework include paths', async () => {
        ...
        expect(config.includePaths).toContain('/framework/arduino/cores/arduino');
        expect(config.includePaths).toContain('/framework/arduino/variants/STM32F103C8');
    ...
    describe('Common Build Configuration', () => {
      it('should generate correct linker arguments', async () => {
        ...
        expect(config.linkerArgs).toContain('--script=/platform/stm32/f1/linker/stm32f103c8.ld');
      ...
      it('should set correct linker script path', async () => {
        ...
        expect(config.linkerScript).toBe('/platform/stm32/f1/linker/stm32f103c8.ld');
      });
    });
    ...
    describe('Framework Comparison', () => {
      it('should generate different configs for native vs Arduino', async () => {
        ...
        expect(nativeConfig.compilerArgs).not.toEqual(arduinoConfig.compilerArgs);

        // Include paths should differ
        expect(nativeConfig.includePaths).not.toEqual(arduinoConfig.includePaths);
