...
const ProjectsPage = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.9)), url('/images/black.jpg')",
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-gray-400 mb-12 max-w-2xl mx-auto font-mono">
          Exploring the intersections of hardware, software, and security. Here
          are some of the things I&apos;m currently working on or have built.
        </p>
