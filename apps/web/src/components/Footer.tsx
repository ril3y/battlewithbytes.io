        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm font-mono">
              ...
              <br />A hub for cybersecurity, embedded hardware, and software
              engineering.
            </p>
          </div>
          <div>
              ...
              <li>
                ...
                >
                  ...
                  >
                    ...
                    <path
                      d="M60 92c-9.6-9.8-28-27.2-28-43.2C32 35.2 44.2 28 60 28s28 7.2 28 20.8C88 64.8 69.6 82.2 60 92z"
              ...
              <li>
                ...
                >
                  ...
                  >
                    ...
                    ></circle>
                    <path
                      d="M40,80a144,144,0,0,1,144,144"
                      fill="none"
                      stroke="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
