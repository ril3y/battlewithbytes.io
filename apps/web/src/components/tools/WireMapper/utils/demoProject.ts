...
export const demoProject: WireMapperProject = {
  ...
  connectors: [
    (() => {
      const conn = createConnector('conn-ecu-main', 'ECU Main', 'DB25 Male', 100, 100, 2, 6, 'Male');
    ...
    (() => {
      const conn = createConnector('conn-sensor-module', 'Sensor Module', '6-Pin Connector', 400, 100, 2, 3, 'Female');
      conn.pins[0].name = 'VCC';
      conn.pins[0].config = { color: '#ff0000', type: 'power' };
      conn.pins[1].name = 'GND';
      conn.pins[1].config = { color: '#000000', type: 'ground' };
    ...
    (() => {
      const conn = createConnector('conn-canbus', 'CAN Bus', '4-Pin CAN', 100, 300, 1, 4, 'Unknown');
      conn.pins[0].name = 'VCC';
      conn.pins[0].config = { color: '#ff0000', type: 'power' };
    ...
    (() => {
      const conn = createConnector('conn-relay-board', 'Relay Board', '4-Pin Power', 400, 300, 1, 4, 'Female');
  ...
  mappings: [
    // Power connections
    { id: 'map-1', wireId: 'wire-1', source: { connectorId: 'conn-ecu-main', pinPos: 1 }, target: { connectorId: 'conn-sensor-module', pinPos: 1 }, netName: '12V_SUPPLY', color: '#ff0000', gauge: '18 AWG' },
    { id: 'map-2', wireId: 'wire-2', source: { connectorId: 'conn-ecu-main', pinPos: 1 }, target: { connectorId: 'conn-canbus', pinPos: 1 }, netName: '12V_SUPPLY', color: '#ff0000', gauge: '18 AWG' },
    { id: 'map-3', wireId: 'wire-3', source: { connectorId: 'conn-ecu-main', pinPos: 1 }, target: { connectorId: 'conn-relay-board', pinPos: 4 }, netName: '12V_SUPPLY', color: '#ff0000', gauge: '16 AWG' },

    // Ground connections
    { id: 'map-4', wireId: 'wire-4', source: { connectorId: 'conn-ecu-main', pinPos: 2 }, target: { connectorId: 'conn-sensor-module', pinPos: 2 }, netName: 'GROUND', color: '#000000', gauge: '18 AWG' },
    { id: 'map-5', wireId: 'wire-5', source: { connectorId: 'conn-ecu-main', pinPos: 2 }, target: { connectorId: 'conn-canbus', pinPos: 4 }, netName: 'GROUND', color: '#000000', gauge: '18 AWG' },
    { id: 'map-6', wireId: 'wire-6', source: { connectorId: 'conn-ecu-main', pinPos: 2 }, target: { connectorId: 'conn-relay-board', pinPos: 3 }, netName: 'GROUND', color: '#000000', gauge: '18 AWG' },

    // CAN Bus connections
    { id: 'map-7', wireId: 'wire-7', source: { connectorId: 'conn-ecu-main', pinPos: 3 }, target: { connectorId: 'conn-canbus', pinPos: 2 }, netName: 'CAN_HIGH', color: '#ffff00', gauge: '24 AWG' },
    { id: 'map-8', wireId: 'wire-8', source: { connectorId: 'conn-ecu-main', pinPos: 4 }, target: { connectorId: 'conn-canbus', pinPos: 3 }, netName: 'CAN_LOW', color: '#00ff00', gauge: '24 AWG' },

    // Sensor connection
    { id: 'map-9', wireId: 'wire-9', source: { connectorId: 'conn-ecu-main', pinPos: 5 }, target: { connectorId: 'conn-sensor-module', pinPos: 3 }, netName: 'TEMP_SENSOR', color: '#0000ff', gauge: '22 AWG' },

    // Relay control
    { id: 'map-10', wireId: 'wire-10', source: { connectorId: 'conn-ecu-main', pinPos: 7 }, target: { connectorId: 'conn-relay-board', pinPos: 1 }, netName: 'RELAY_CTRL_1', color: '#00ffff', gauge: '22 AWG' },
    { id: 'map-11', wireId: 'wire-11', source: { connectorId: 'conn-ecu-main', pinPos: 8 }, target: { connectorId: 'conn-relay-board', pinPos: 2 }, netName: 'RELAY_CTRL_2', color: '#ffa500', gauge: '22 AWG' },
  ],
};
