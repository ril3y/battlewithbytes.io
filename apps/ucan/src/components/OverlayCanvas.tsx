        ...
        return (
          <div className="flex flex-col items-center justify-center text-yellow-400 text-xs p-2 text-center">
            <div className="font-semibold">
              {widget.config.label || widget.fieldName}
            </div>
            <div className="text-yellow-500 mt-1">
              Field &quot;{widget.fieldName}&quot; not found in{" "}
              {widget.messageId}
            </div>
          </div>
        );
  ...
  return (
    <div style={gridStyle}>
      {layout.widgets.map((layoutWidget) => {
        ...
        const widget = widgetMap.get(widgetId);
        const isHighlighted =
          selectedMessageId && widget?.messageId === selectedMessageId;
            ...
            {isHighlighted && (
              <div
                ...
                style={{
                  ...
                  borderRadius: "8px",
                  boxShadow:
                    "0 0 20px rgba(251, 191, 36, 0.6), inset 0 0 20px rgba(251, 191, 36, 0.2)",
